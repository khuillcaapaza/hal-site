    ...
    <main>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Acción: ir al cronograma de citas */}
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 bg-green-50 border border-green-100 rounded-2xl p-6 text-center">
            <p className="text-gray-700 font-medium">
              Consulta los días de entrega de citas por área en el cronograma mensual.
            </p>
            <Link
              href="/cronograma-citas"
              className="inline-flex items-center gap-2 bg-green-700 text-white font-semibold px-8 py-3 rounded-full hover:bg-green-800 transition-colors flex-shrink-0"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
              Ver cronograma de citas
            </Link>
          </div>
