    ...
    <section id="servicios" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">Servicios en línea</h2>
          <p className="text-gray-500 mt-3 max-w-xl mx-auto">
            Accede a los trámites y servicios institucionales del Hospital Antonio Lorena.
          </p>
        </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-bold text-gray-900 text-lg mb-2 flex items-center gap-1.5">
                  {svc.title}
                  {svc.external && (
                    <svg className="w-4 h-4 text-green-700 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
