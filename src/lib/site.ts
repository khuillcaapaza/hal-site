...
export const documentosGestion = [
  ...
  },
  {
    ...
    icon: "complaints",
    documents: [
      { title: "Comunicado N° 1", href: "/documentos/comunicados/comunicado1.pdf" },
      { title: "Comunicado N° 2", href: "/documentos/comunicados/comunicado2.pdf" },
      { title: "Comunicado N° 3", href: "/documentos/comunicados/comunicado3.pdf" },
      { title: "Comunicado N° 4", href: "/documentos/comunicados/comunicado4.pdf" },
      { title: "Comunicado N° 5", href: "/documentos/comunicados/comunicado5.pdf" },
      { title: "Comunicado N° 6", href: "/documentos/comunicados/comunicado6.pdf" },
    ] as { title: string; date?: string; href: string }[],
  },
  {
